...
const chunkAmountFifteenHundred = document.getElementById("chunkAmountFifteenHundred");
...
const studentsPendingFeesList = document.getElementById("studentsPendingFeesList");
...
function makePayment() {
    ...
    if (isNaN(inputPaymentAmount) ||
        inputPaymentAmount <= 0 ||
        inputPaymentAmount > remainBalance) {
        window.alert("whatever you wrote is either not valid numbers or is too High than the fee amount you own");
    }
    else {
